...
static void	init_images(t_game *game)
{
	...
	game->imgs.player_addr = (int *)mlx_get_data_addr(game->imgs.player, &a, &a, &a);
	game->imgs.wall_addr = (int *)mlx_get_data_addr(game->imgs.wall, &a, &a, &a);
	game->imgs.exit_addr = (int *)mlx_get_data_addr(game->imgs.exit, &a, &a, &a);
	game->imgs.coin_addr = (int *)mlx_get_data_addr(game->imgs.coin, &a, &a, &a);
	game->imgs.bg_addr = (int *)mlx_get_data_addr(game->imgs.bg, &a, &a, &a);
